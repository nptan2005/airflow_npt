...
from data_kit_plugin.conn_kit.connKitConstant import ConnKitConstant
from data_kit_plugin.utilities.data_config import configuration
import logging

# from IPython.display import HTML, display

class EmailSendOperator(BaseOperator):
    @apply_defaults
    def __init__(self, connection_name:str = ConnKitConstant.EMAIL_ACCT_DEFAULT
                 ,email_template:str = ConnKitConstant.EMAIL_TEMPLATE_DEFAULT
                 ,*args
                 , **kwargs):
